...
?>
	...
	?>
		<span style="margin-left:8px;"><a href="<?= $attachmail ?>" style="white-space:nowrap" id="show_ticket_attch" style="margin-left:8px;" href=""><img src="/<?=ROOT_FOLDER?>images/attachment.png"></a></span>
	<?php } ?>
</div>
</td>

<td align="left" style="padding: 5px;border-right: 1px solid #ccc; line-height: 15px;">
    <font face="Arial, Helvetica, sans-serif" size="2" color="#5d5d5d" style="font-size: 14px;white-space: nowrap;"><?=date('m-d-Y',strtotime($row['TaskCretedDate']));?></font>
</td>

<?php //if($row['TickleName'] == 'delegate' || $row['TickleName'] == 'errands') {?>
<td align="left" style="padding: 5px;border-right: 1px solid #ccc; line-height: 15px;">
    <font face="Arial, Helvetica, sans-serif" size="2" color="#5d5d5d" style="font-size: 14px;white-space: nowrap;"><?php echo htmlspecialchars($row['ccaddress']);?></font>
</td>
<?php //}?>
