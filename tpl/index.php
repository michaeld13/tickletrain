    ...
    <head>
		...
		<?php
		 if($_GET['u'] == 'edittask'){ ?>
            ...
            <link rel="stylesheet" href="/<?= ROOT_FOLDER ?>plugins/css/jquery-ui-timepicker-addon.min.css" type="text/css" media="all"/>
            ...
            <script type="text/javascript" src="/<?= ROOT_FOLDER ?>plugins/timepicker-new.js"></script>
			<script type="text/javascript" src="/<?= ROOT_FOLDER ?>plugins/jquery-ui-sliderAccess.js"></script>
