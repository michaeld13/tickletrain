...
// $mailBcc->IsHTML(true);
    ...
    */
    ...
    $sqlQuery = "SELECT tickleuser.TickleID,tickleuser.TimeZone, tickleuser.EmailID,google_auth_tokens.access_token, google_auth_tokens.refresh_token, google_auth_tokens.created as google_token_created_date, google_auth_tokens.expires_in, tickleuser.signature , tickleuser.enable_alt , tickleuser.alt_email , tickleuser.imap_host , tickleuser.imapOff, tickleuser.delete_all_campaign, tickleuser.imap_userame, tickleuser.imap_passowrd,tickleuser.imap_port,tickleuser.imap_secure FROM `tickleuser` LEFT JOIN  google_auth_tokens  ON google_auth_tokens.userid = tickleuser.TickleID  WHERE  tickleuser.imapOff != '1' AND ((google_auth_tokens.access_token != '' AND google_auth_tokens.refresh_token != '') OR (tickleuser.imap_passowrd != '' AND tickleuser.imap_userame != '' AND tickleuser.imap_host != ''))";
